...
<div itemscope itemtype="https://schema.org/Organization"
	class="aioseo-location-box aioseo-location-<?php echo absint( $postId ); ?> <?php echo esc_attr( $instance['class'] ); ?>"> <?php // phpcs:ignore Generic.Files.LineLength.MaxExceeded ?>
	<?php
	...
	<?php if ( $instance['showAddress'] || $instance['showVat'] || $instance['showTax'] || $instance['showChamberId'] || $instance['showName'] ) { ?>
		<div class="col">
			<div class="d-flex">
				...
				<div class="col-auto">
					<span class="icon location"><?php echo $svgLocationPin; // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped ?></span>
				</div>

				<div class="col">

					<?php if ( ! $instance['showAddress'] && $instance['showName'] && ! empty( $locationData->name ) ) { ?>
						<div class="aioseo-name-details" itemprop="name">
					...
					<div class="aioseo-tax-details">
						<?php if ( $instance['showVat'] && ! empty( $locationData->ids->vat ) ) { ?>
							<div>
								<div class="label">
									<?php esc_html_e( 'VAT ID:', 'aioseo-local-business' ); ?>
								</div>
								<span itemprop="vatID" class="item">
						...
						<?php if ( $instance['showTax'] && ! empty( $locationData->ids->tax ) ) { ?>
							<div>
								<div class="label">
									<?php esc_html_e( 'Tax ID:', 'aioseo-local-business' ); ?>
								</div>
								<span itemprop="taxID" class="item">
	...
	<div class="col-auto">
		<div class="aioseo-contact-details">
			<?php if ( $instance['showPhone'] && ! empty( $locationData->contact->phoneFormatted ) ) { ?>
				<div class="d-flex">
					<div class="col-auto">
						<span class="icon"><?php echo $svgPhone; // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped ?></span>
					</div>

					<div class="col">
						<div class="label">
							<?php esc_html_e( 'Phone:', 'aioseo-local-business' ); ?>
						</div>
						<span itemprop="telephone" class="item">
			...
			<?php if ( $instance['showFax'] && ! empty( $locationData->contact->faxFormatted ) ) { ?>
				<div class="d-flex">
					...
					<div class="col">
						<div class="label">
							<?php esc_html_e( 'Fax:', 'aioseo-local-business' ); ?>
						</div>
						<span itemprop="faxNumber" class="item">
			...
			<?php if ( $instance['showEmail'] && ! empty( $locationData->contact->email ) ) { ?>
				<div class="d-flex">
					<div class="col-auto">
						<span class="icon"><?php echo $svgEmail; // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped ?></span>
					</div>

					<div class="col">
						<div class="label">
							<?php esc_html_e( 'Email:', 'aioseo-local-business' ); ?>
						</div>
						<span itemprop="email" class="item">
