...
class OpeningHours extends \WP_Widget {
	...
	public function update( $newInstance, $oldInstance ) { // phpcs:ignore VariableAnalysis.CodeAnalysis.VariableAnalysis.UnusedVariable
		...
		$newInstance['showTitle']     = isset( $newInstance['showTitle'] ) ? '1' : false;
		$newInstance['showIcons']     = isset( $newInstance['showIcons'] ) ? '1' : false;
		$newInstance['showMonday']    = isset( $newInstance['showMonday'] ) ? '1' : false;
		$newInstance['showTuesday']   = isset( $newInstance['showTuesday'] ) ? '1' : false;
		$newInstance['showWednesday'] = isset( $newInstance['showWednesday'] ) ? '1' : false;
		$newInstance['showThursday']  = isset( $newInstance['showThursday'] ) ? '1' : false;
		$newInstance['showFriday']    = isset( $newInstance['showFriday'] ) ? '1' : false;
		$newInstance['showSaturday']  = isset( $newInstance['showSaturday'] ) ? '1' : false;
		$newInstance['showSunday']    = isset( $newInstance['showSunday'] ) ? '1' : false;
