...
new AIOSEOExtend( 'AIOSEO - News Sitemap', 'aioseo_news_sitemap_load', AIOSEO_NEWS_SITEMAP_FILE, '4.0.0' );
...
function aioseo_news_sitemap_load() {
	...
	$extend = new AIOSEOExtend( 'AIOSEO - News Sitemap', '', AIOSEO_NEWS_SITEMAP_FILE, '4.0.0', $levels );
	if ( ! aioseo()->pro ) {
